...
# Declare exchange and queue (same as Producer 1)
...
print(f'Consumer 1 connected. Listening to queue: {queue_name}')
print('Waiting for messages from Producer 1...\n')
